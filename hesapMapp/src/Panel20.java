...
public class Panel20 extends JPanel {
    JButton b1;
    JTextField t1;
    JLabel e1, e2;
    Timer timer;
    ...
    public Panel20() {
        ...
        b1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (input.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Boş değer girmeyin!");
                    return;
                }
                else {
                	try {
                         ...
                         if (isPerfectNumber(number)) {
                        	 e2.setText("<html><div style='text-align: center;'>Sonuç<br><span style='font-size: 9px;'>" +""+ number +"<br> mükemmel<br> bir<br> sayıdır."+ "</span></div></html>");
                         } else {
                        	 e2.setText("<html><div style='text-align: center;'>Sonuç<br><span style='font-size: 9px;'>" +""+ number +"<br> mükemmel<br> bir sayı<br> değildir."+ "</span></div></html>");
                         }
